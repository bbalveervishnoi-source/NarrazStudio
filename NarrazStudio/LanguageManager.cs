...
namespace NarrazStudio
{
    public class LanguageManager : INotifyPropertyChanged
    {
        ...
        private Dictionary<string, string> _english = new()
        {
            ...
            {"FFmpegMissing", "FFmpeg Missing: Please check the Engine folder."},
            ...
            {"LegalFFmpeg", "FFmpeg is used under the GNU LGPL v2.1+ license for audio chunk merging and post-processing. FFmpeg binaries are bundled in the Engine folder and are not modified."},
